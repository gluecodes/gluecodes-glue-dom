...
/***/ "./src/create-virtual-dom-enhancer.js":
/*!********************************************!*\
  !*** ./src/create-virtual-dom-enhancer.js ***!
  \********************************************/
/*! no static exports found */
...
eval("/* WEBPACK VAR INJECTION */(function(global) {function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nmodule.exports = function (_ref) {\n  var customFilter = _ref.customFilter,\n      enhance = _ref.enhance,\n      _ref$filesToLoad = _ref.filesToLoad,\n      filesToLoad = _ref$filesToLoad === void 0 ? {} : _ref$filesToLoad,\n      name = _ref.name;\n  return function (props) {\n    if (!props) {\n      return {};\n    }\n\n    var Hook = function Hook() {};\n\n    var nodeInitIndicatorClass = 'gc-enhanced-node';\n\n    Hook.prototype.hook =\n    /*#__PURE__*/\n    function () {\n      var _ref2 = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee2(node) {\n        var fileIds, _loop, _i;\n\n        return regeneratorRuntime.wrap(function _callee2$(_context3) {\n          while (1) {\n            switch (_context3.prev = _context3.next) {\n              case 0:\n                if (!(typeof customFilter === 'function' && !customFilter({\n                  node: node,\n                  props: props\n                }))) {\n                  _context3.next = 2;\n                  break;\n                }\n\n                return _context3.abrupt(\"return\");\n\n              case 2:\n                if (!(typeof customFilter !== 'function' && (!node.isConnected || node.classList.contains(nodeInitIndicatorClass)))) {\n                  _context3.next = 4;\n                  break;\n                }\n\n                return _context3.abrupt(\"return\");\n\n              case 4:\n                fileIds = Object.keys(filesToLoad);\n                node.classList.add(nodeInitIndicatorClass);\n                _context3.prev = 6;\n                _loop =\n                /*#__PURE__*/\n                regeneratorRuntime.mark(function _loop() {\n                  var fileId, fileUri, scriptLoadIndicatorId;\n                  return regeneratorRuntime.wrap(function _loop$(_context2) {\n                    while (1) {\n                      switch (_context2.prev = _context2.next) {\n                        case 0:\n                          fileId = fileIds[_i];\n                          fileUri = filesToLoad[fileId];\n                          scriptLoadIndicatorId = \"gc-external-script-\".concat(fileId); // eslint-disable-next-line no-await-in-loop\n\n                          _context2.next = 5;\n                          return _asyncToGenerator(\n                          /*#__PURE__*/\n                          regeneratorRuntime.mark(function _callee() {\n                            return regeneratorRuntime.wrap(function _callee$(_context) {\n                              while (1) {\n                                switch (_context.prev = _context.next) {\n                                  case 0:\n                                    return _context.abrupt(\"return\", new Promise(function (resolve, reject) {\n                                      if (global.document.getElementById(scriptLoadIndicatorId)) {\n                                        resolve();\n                                        return;\n                                      }\n\n                                      var tagToAppend;\n\n                                      if (/\\.css$/.test(fileUri)) {\n                                        tagToAppend = global.document.createElement('style');\n                                        tagToAppend.type = 'text/css';\n                                        tagToAppend.rel = 'stylesheet';\n                                        tagToAppend.href = fileUri;\n                                      } else {\n                                        tagToAppend = global.document.createElement('script');\n                                        tagToAppend.src = fileUri;\n                                      }\n\n                                      tagToAppend.id = scriptLoadIndicatorId;\n\n                                      tagToAppend.onload = function () {\n                                        return resolve();\n                                      };\n\n                                      tagToAppend.onerror = function () {\n                                        return reject(new Error(\"Could not load: \".concat(fileUri)));\n                                      };\n\n                                      global.document.head.appendChild(tagToAppend);\n                                    }));\n\n                                  case 1:\n                                  case \"end\":\n                                    return _context.stop();\n                                }\n                              }\n                            }, _callee, this);\n                          }))();\n\n                        case 5:\n                        case \"end\":\n                          return _context2.stop();\n                      }\n                    }\n                  }, _loop, this);\n                });\n                _i = 0;\n\n              case 9:\n                if (!(_i < fileIds.length)) {\n                  _context3.next = 14;\n                  break;\n                }\n\n                return _context3.delegateYield(_loop(), \"t0\", 11);\n\n              case 11:\n                _i++;\n                _context3.next = 9;\n                break;\n\n              case 14:\n                _context3.next = 21;\n                break;\n\n              case 16:\n                _context3.prev = 16;\n                _context3.t1 = _context3[\"catch\"](6);\n                node.classList.remove(nodeInitIndicatorClass); // eslint-disable-next-line no-console\n\n                console.error(_context3.t1);\n                return _context3.abrupt(\"return\");\n\n              case 21:\n                enhance({\n                  node: node,\n                  props: props\n                });\n\n              case 22:\n              case \"end\":\n                return _context3.stop();\n            }\n          }\n        }, _callee2, this, [[6, 16]]);\n      }));\n\n      return function (_x) {\n        return _ref2.apply(this, arguments);\n      };\n    }();\n\n    return _defineProperty({}, name, new Hook());\n  };\n};\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../node_modules/webpack/buildin/global.js */ \"./node_modules/webpack/buildin/global.js\")))\n\n//# sourceURL=webpack:///./src/create-virtual-dom-enhancer.js?");
